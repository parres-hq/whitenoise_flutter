...
- Fixed issue where user details on media preview modal overlaps the image/ image not properly vertically centered [#880](https://github.com/marmot-protocol/whitenoise/issues/880)
