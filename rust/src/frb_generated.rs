...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1927251102;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        21 => wire__crate__api__initialize_whitenoise_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__login_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__logout_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__public_key_from_string_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__relay_type_inbox_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__relay_type_key_package_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__relay_type_nostr_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__relay_url_from_string_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__remove_contact_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__update_active_account_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__update_contacts_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__update_metadata_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__update_relays_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
