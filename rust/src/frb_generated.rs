...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -915509009;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__accounts__account_follows_impl(port, ptr, rust_vec_len, data_len),
        2 => {
        ...
        11 => wire__crate__api__app_update__check_for_app_update_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        28 => wire__crate__api__groups__get_chat_list_impl(port, ptr, rust_vec_len, data_len),
