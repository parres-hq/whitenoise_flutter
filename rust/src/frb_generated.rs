...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 533045578;
...
fn wire__crate__api__app_update__check_for_app_update_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "check_for_app_update",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::error::ApiError>(
                    (move || async move {
                        let output_ok =
                            crate::api::app_update::check_for_app_update(api_current_version)
                                .await?;
                        Ok(output_ok)
                    })()
                    .await,
...
impl SseDecode for crate::api::app_update::AppUpdateInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_version = <String>::sse_decode(deserializer);
        let mut var_updateAvailable = <bool>::sse_decode(deserializer);
        return crate::api::app_update::AppUpdateInfo {
            version: var_version,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        12 => wire__crate__api__app_update__check_for_app_update_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        16 => wire__crate__api__welcomes__decline_welcome_impl(port, ptr, rust_vec_len, data_len),
        ...
        24 => wire__crate__api__welcomes__find_welcome_by_event_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        62 => wire__crate__api__accounts__unfollow_user_impl(port, ptr, rust_vec_len, data_len),
        63 => wire__crate__api__accounts__update_account_metadata_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__api__update_theme_mode_impl(port, ptr, rust_vec_len, data_len),
        65 => wire__crate__api__accounts__upload_account_profile_picture_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        67 => wire__crate__api__groups__upload_group_image_impl(port, ptr, rust_vec_len, data_len),
        68 => wire__crate__api__users__user_has_key_package_impl(port, ptr, rust_vec_len, data_len),
        69 => wire__crate__api__users__user_metadata_impl(port, ptr, rust_vec_len, data_len),
        70 => wire__crate__api__users__user_relays_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::app_update::AppUpdateInfo {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::app_update::AppUpdateInfo
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::app_update::AppUpdateInfo>
    for crate::api::app_update::AppUpdateInfo
{
    fn into_into_dart(self) -> crate::api::app_update::AppUpdateInfo {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::app_update::AppUpdateInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
