...
class DefaultData {
  ...
  static const List<MenuItem> myMessageMenuItems = [reply, forward, edit, copy, delete];

  static const MenuItem reply = MenuItem(label: 'Reply', icon: CarbonIcons.reply);

  static const MenuItem copy = MenuItem(label: 'Copy', icon: CarbonIcons.copy);

  static const MenuItem forward = MenuItem(label: 'Forward', icon: CarbonIcons.send);

  static const MenuItem edit = MenuItem(label: 'Edit', icon: CarbonIcons.edit);

  static const MenuItem delete = MenuItem(label: 'Delete', icon: CarbonIcons.delete, isDestructive: true);
}
