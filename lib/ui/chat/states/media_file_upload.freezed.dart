...
class _$MediaFileUploadedImpl implements MediaFileUploaded {
  const _$MediaFileUploadedImpl({required this.file});
  ...
  @override
  String toString() {
    return 'MediaFileUpload.uploaded(file: $file)';
  }
  ...
  _$$MediaFileUploadedImplCopyWith<_$MediaFileUploadedImpl> get copyWith =>
      __$$MediaFileUploadedImplCopyWithImpl<_$MediaFileUploadedImpl>(this, _$identity);
...
abstract class MediaFileUploaded implements MediaFileUpload {
  const factory MediaFileUploaded({required final MediaFile file}) = _$MediaFileUploadedImpl;
...
class _$MediaFileUploadFailedImpl implements MediaFileUploadFailed {
  const _$MediaFileUploadFailedImpl({required this.filePath, required this.error});
  ...
  _$$MediaFileUploadFailedImplCopyWith<_$MediaFileUploadFailedImpl> get copyWith =>
      __$$MediaFileUploadFailedImplCopyWithImpl<_$MediaFileUploadFailedImpl>(this, _$identity);
