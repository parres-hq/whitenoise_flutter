      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Paste your relay address', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w500, color: AppColors.color2D312D)),
              Gap(8.h),
              Row(
                children: [
                  Expanded(
        ...
        CustomButton(onPressed: _isUrlValid ? _addRelay : null, title: 'Add Relay', buttonType: ButtonType.primary),
        Gap(24.h),
      ],
    );
  }
