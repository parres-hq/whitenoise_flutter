      ...
      children: [
        ...
        if (items.isEmpty)
          Padding(
            ...
            child: Text(emptyText, style: TextStyle(fontSize: 17.sp, color: AppColors.color727772)),
          )
        else
          ListView.builder(
            shrinkWrap: true,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(relay.url, style: TextStyle(fontSize: 18.sp, color: AppColors.color202320)),
          Row(
            children: [
              SvgPicture.asset(
