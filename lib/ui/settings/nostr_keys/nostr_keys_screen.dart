              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Gap(12.w),
                    Expanded(child: Text(_publicKey, style: TextStyle(fontSize: 14.sp, color: AppColors.color727772))),
                  ],
                ),
              ),
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(border: Border.all(color: AppColors.colorE2E2E2)),
                      child: Padding(
...
class SectionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: TextStyle(fontSize: 24.sp, color: AppColors.color2D312D)),
        Gap(8.h),
        Text(description, style: TextStyle(fontSize: 16.sp, color: AppColors.color727772)),
      ],
    );
  }
}
...
class SettingsButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: buttonColor ?? AppColors.colorF2F2F2),
      child: InkWell(
        onTap: onTap,
        child: Row(
          ...
          children: [
            SvgPicture.asset(
              ...
              width: 16.w,
              height: 16.w,
              colorFilter: ColorFilter.mode(titleColor ?? AppColors.color202320, BlendMode.srcIn),
            ),
            Gap(8.w),
            Text(
              title,
              style: TextStyle(
                ...
                color: titleColor ?? AppColors.color202320,
              ),
            ),
          ],
        ),
